...
```
TypeError: Unknown file extension ".ts" for .\openapi.config.ts
...
检查你的 package.json 中是否有 type: "module"，如果有，试着将其移除
...
```
npm install github-markdown-css --force
```
...
在题目管理（question）页面新增 visible 变量，用于控制弹窗是否显示：
